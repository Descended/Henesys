...
public class FileTime implements Serializable {
    ...
    public boolean isPermanent() {
        return equals(FileTime.fromType(Type.MAX_TIME)) ||
                equals(new FileTime(21968699, -35635200)) ||
                equals(new FileTime(2046875368, 58992));
    }
    ...
    /**
     * Gets the number for seconds between this file time and now.
     * Will be negative, if the file time is in the past.
     * @return a signed long integer representing the number of seconds
     */
    public long secondsFromTimeNow() {
        return LocalDateTime.now().until(toLocalDateTime(), ChronoUnit.SECONDS);
    }
